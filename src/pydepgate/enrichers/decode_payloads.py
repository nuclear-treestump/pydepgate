...
Renderers for DecodedTree have moved to the dedicated reporters
package as part of the reporter-centralization refactor:

    pydepgate.reporters.decoded_tree.text.render
    pydepgate.reporters.decoded_tree.sources.render
    pydepgate.reporters.decoded_tree.iocs.render
    pydepgate.reporters.decoded_tree.json.render

This module is now algorithm-only.
